...
async function fetchApiJson(url) {
    try {
        const res = await fetch__default['default'](url).then(res => res.json());
        return res;
    }
    catch (err) {
...
async function writeExport(templates, folder) {
...
async function main({ url, output, requestPath, exportsRequest }) {
